class Toroidalfin extends Goldfish {
 ...
 triangle(tailX, tailY, tailX - addX *signX, tailY -signY* addY, tailX - addY *signX, tailY - addX *signY);
  ...
  public boolean tryToEat(Tankable p) {
    ...
    if (p instanceof Toroidalfin && this.hasCollision(p)  && this.alive() && p.alive()) {
    ...
    }// adds a new Toroidalfin if two Toroidalfins mated
    return false;
  }//troToEat method
}//Toroidalfin Class
